...
#define RS                     0.16 /* Stator resistance , ohm*/
#define LS                     0.00009 /* Stator inductance, H
...
#define NOMINAL_CURRENT         8164
#define MOTOR_MAX_SPEED_RPM     10000 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  2.6 /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG                -8164 /*!< Demagnetization current */
...
/*** Quadrature encoder ***/
#define M1_ENCODER_PPR             5000  /*!< Number of pulses per
                                            revolution */
